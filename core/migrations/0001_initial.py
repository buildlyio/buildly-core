    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_preferences', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('push_preferences', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
        ...
        migrations.RunPython(migrate_email_alert,
