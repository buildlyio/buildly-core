...
def datamesh():
    ...
    lm2 = factories.LogicModule.create(name='documents', endpoint_name='documents',
                                       endpoint='http://documentservice:8080')
    lmm1 = factories.LogicModuleModel(logic_module=lm1, model='SiteProfile', endpoint='/siteprofiles/',
                                      lookup_field_name='uuid')
    lmm2 = factories.LogicModuleModel(logic_module=lm2, model='Document', endpoint='/documents/',
