...
class Portfolio(models.Model):
    ...
    organization = models.ForeignKey(Organization, blank=True, null=True, help_text="Related Organization that created portfolio")
...
class WorkflowTeam(models.Model):
    workflow_user = models.ForeignKey(CoreUser, blank=True, null=True, related_name="auth_approving", help_text='User with access/permissions to related workflowlevels')
    workflowlevel1 = models.ForeignKey(WorkflowLevel1, null=True, blank=True, help_text='Related workflowlevel 1')
    ...
    role = models.ForeignKey(Group, null=True, blank=True, help_text='Type of access via related group')
    create_date = models.DateTimeField(null=True, blank=True)
    edit_date = models.DateTimeField(null=True, blank=True)
...
class WorkflowLevel2(models.Model):
    ...
    workflowlevel1 = models.ForeignKey(WorkflowLevel1, verbose_name="Program", related_name="workflowlevel2", help_text="Primary or parent Workflow")
