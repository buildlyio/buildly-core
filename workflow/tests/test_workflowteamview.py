...
from workflow.models import (WorkflowTeam, ROLE_ORGANIZATION_ADMIN,
                             ROLE_WORKFLOW_ADMIN, ROLE_WORKFLOW_TEAM, ROLE_VIEW_ONLY)
...
class WorkflowTeamListViewsTest(TestCase):
    def setUp(self):
        ...
        core_user_ringo = factories.CoreUser(
            first_name='Ringo', last_name='Starr', organization=factories.Organization())
        self.wflvl1 = factories.WorkflowLevel1(
            organization=core_user_ringo.organization)
        factories.WorkflowTeam(workflow_user=core_user_ringo,
    ...
    def test_list_workflowteam_superuser(self):
        ...
        request_get.user = self.core_user
    ...
    def test_list_workflowteam_org_admin_diff_user_org(self):
        ...
        core_user_george = factories.CoreUser(
            first_name='George', last_name='Harrison', organization=another_org)
    ...
    def test_list_workflowteam_org_admin_diff_user_same_org(self):
        ...
        core_user_george = factories.CoreUser(
            first_name='George', last_name='Harrison', organization=self.core_user.organization)
...
class WorkflowTeamUpdateViewsTest(TestCase):
    def setUp(self):
        ...
        core_user_ringo = factories.CoreUser(
            first_name='Ringo', last_name='Starr', organization=self.core_user.organization)
        self.wflvl1 = factories.WorkflowLevel1(
            organization=self.core_user.organization)
        self.workflowteam = factories.WorkflowTeam(
            workflow_user=core_user_ringo,
            workflowlevel1=self.wflvl1,
            role=factories.Group(name=ROLE_VIEW_ONLY))
